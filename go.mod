...
replace github.com/pingcap/tidb => github.com/actiontech/tidb v0.0.0-20230330055952-b2be7d4c14e6

replace github.com/pingcap/tidb/parser => github.com/actiontech/tidb/parser v0.0.0-20230330055952-b2be7d4c14e6
